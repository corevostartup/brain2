...
export default function DesktopSidebar({ onHide, mobileFullscreen = false }: DesktopSidebarProps) {
  return (
    <aside
    ...
    >
      <div className="sidebar-card">
        ...
        <button className="your-brain-btn" type="button" aria-label="Your Brain">
          Your Brain
        </button>

        <section className="section-block" aria-label="Pastas">
